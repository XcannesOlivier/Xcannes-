...
/**
 * Derive an AES-256-GCM key from WebAuthn PRF output.
 * The PRF extension produces a deterministic secret per credential,
 * which we feed into PBKDF2 as high-entropy key material.
 *
 * @param {ArrayBuffer} webauthnSignature - PRF output from WebAuthn assertion
...
export async function deriveKeyFromWebAuthn(webauthnSignature, salt) {
  // Import the PRF output as raw key material for PBKDF2
