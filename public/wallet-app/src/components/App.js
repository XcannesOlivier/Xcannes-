...
// --- Production: silence console to prevent info leaks ---
...
// Lock immediately when app goes to background (tab hidden / app switch)
...
async function unlockWallet() {
  ...
  try {
    ...
    showScreen('scanner');
    setupScannerScreen();
    resetInactivityTimer(); // Start auto-lock timer
...
async function handleConnect(challenge, statusEl) {
  ...
  // Sign the challenge to cryptographically prove wallet ownership
