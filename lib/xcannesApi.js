...
const BACKEND_CONFIG = {
  // Passer par l'API 3001 (qui proxifie /api/v1/* vers Market Data 3003 + XUMM/Stripe/news)
...
class XcannesAPI {
  ...
  async getFxCurrencies() {
    try {
      ...
      console.warn("[XcannesAPI] FX currencies fallback to empty list:", error?.message || error);
      return [];
    }
  }
}
