                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <a
                      ...
                      className="text-xcannes-green hover:text-xcannes-green/80 transition-colors text-sm">{t("ui_xcannesdao_gmail_com_d56c0bbb6b", "xcannesdao@gmail.com")}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <a
                      ...
                      className="text-blue-400 hover:text-blue-300 transition-colors text-sm">{t("ui_www_xcannes_com_bd6ba86eea", "www.xcannes.com")}
