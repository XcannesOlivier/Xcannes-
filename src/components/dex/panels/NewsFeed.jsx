...
export default function NewsFeed({ category = "finance" }) {
  ...
  if (loading && news.length === 0) {
    return (
      <div className="p-4 text-center">
        ...
        <p className="text-xs text-white/40">{t("ui_loading_news_1acd983fe2", "Loading news...")}</p>
      </div>);
  ...
  if (news.length === 0) {
    return (
      <div className="p-4 text-center">
        <p className="text-xs text-white/40">{t("ui_no_news_available_4b27c89c76", "No news available")}</p>
      </div>);
    ...
    <div className="h-full flex flex-col bg-gradient-to-b from-xcannes-black via-xcannes-black to-xcannes-dark">
      ...
      <div className="p-3 border-b border-white/10">
        <div className="flex items-center justify-between">
          <h3 className="hidden md:block text-base md:text-sm font-bold text-white">{t("ui_news_aggregated_from_local_m_95cf04e755", "News aggregated from local media sources.")}
      ...
      <div className="p-2 border-t border-white/10 text-center md:hidden">
        <p className="text-sm md:text-xs text-white/30">{t("ui_news_aggregated_from_local_m_95cf04e755", "News aggregated from local media sources.")}
