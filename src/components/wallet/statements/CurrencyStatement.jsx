    ...
    >
      ...
      >
            ...
            {swipeEnabled ? (
              ...
              <p className="mt-0 text-[15px] md:text-[16px] text-white/55 leading-relaxed">
                {t(
          ...
          <div className={`space-y-3 ${periodDropdownOpen ? "relative z-[60]" : ""}`}>
            {/* Balance + USD estimé */}
            {!isXrpNetworkView ? (
              <div className="flex flex-col items-center text-center gap-0.5 mb-4 w-fit mx-auto rounded-2xl ring-1 ring-white/10 ring-inset bg-[#111518] shadow-[0_4px_18px_rgba(0,0,0,0.6),inset_0_16px_28px_rgba(255,255,255,0.08),inset_0_-14px_24px_rgba(0,0,0,0.30)] px-8 py-4">
            ...
            <div className={`flex items-end gap-3 ${periodDropdownOpen ? "relative z-[60]" : ""}`}>
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[13px] md:text-[13px] text-white/85 font-medium mb-1 text-center">
