    ...
    >
      ...
      >
          ...
          <div className={`space-y-3 ${periodDropdownOpen ? "relative z-[60]" : ""}`}>
            {/* Balance + USD estimé */}
            {!isXrpNetworkView ? (
              <div className="flex flex-col items-center text-center gap-0.5 mb-4 w-fit mx-auto rounded-2xl border border-white/10 bg-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.07)] px-8 py-4">
