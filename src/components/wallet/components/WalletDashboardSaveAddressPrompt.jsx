      ...
      <div className="fixed inset-0 z-[10001] flex items-center justify-center px-4 pointer-events-none">
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-white/60 mb-4">{t("ui_would_you_like_to_save_this__117bb9f717", "Would you like to save this address for future use?")}

            </p>
            <div className="mb-4">
              <label className="block text-xs text-white/60 mb-2">{t("ui_address_2ef763fa89", "Address")}</label>
              <div className="bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-xs text-white/80 font-mono break-all">
                {addressToSave}
              </div>
            </div>
            <div className="mb-6">
              <label className="block text-xs text-white/60 mb-2">{t("ui_label_optional_3b6a3c454c", "Label (optional)")}
            ...
            <div className="flex gap-3">
              <button
                onClick={onClose}
                className="flex-1 px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-colors">{t("ui_skip_95d6fefee9", "Skip")}


              </button>
              <button
                onClick={onSave}
                className="flex-1 px-4 py-2.5 bg-xcannes-green hover:bg-xcannes-green/90 text-black font-semibold rounded-lg transition-colors">{t("ui_save_47661c12f6", "Save")}
