...
export default function QRScanner({ isOpen, onScan, onClose }) {const { t } = useTranslation("common");
  ...
  <div className="fixed inset-0 z-[10100] flex items-center justify-center p-4 bg-black/95">
      <div className="relative w-full max-w-md bg-elevated border border-subtle rounded-2xl p-6 shadow-2xl">
        ...
        {/* Title */}
        <h3 className="text-xl font-orbitron font-bold text-white mb-4 text-center">{t("ui_scan_qr_code_481606b590", "Scan QR Code")}
        ...
        <div className="mb-4">
          <label className="block text-xs text-white/60 mb-2">{t("ui_or_upload_a_qr_image_works_e_df6baa8039", "Or upload a QR image (works even on HTTP):")}
