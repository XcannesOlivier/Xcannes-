        ...
        >
          <div className="wallet-action-icon">
            ...
            >
	          ...
	          <span className="wallet-action-label !text-[16px] md:!text-[18px] !font-medium">
        ...
        >
          <div className="wallet-action-icon">
            ...
            >
	          ...
	          <span className="wallet-action-label !text-[15px] md:!text-[18px] !font-normal">Banque</span>
	        </button>
	        </div>
      </div>
    </div>
