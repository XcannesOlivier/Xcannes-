    ...
    <div
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-3">
        <button
          ...
          <span className="wallet-action-label">{t("ui_send_bee4f9e2f5", "Send")}</span>
        </button>
        ...
        <button
          ...
          <span className="wallet-action-label">{t("ui_receive_127eab0703", "Receive")}</span>
        </button>
        ...
        <button
          ...
          <span className="wallet-action-label">{t("ui_convert_e0fbc97f15", "Convert")}</span>
        </button>
        ...
        <button
          ...
          <span className="wallet-action-label">{t("ui_buy_sell_ec2ec12982", "Buy/Sell")}</span>
        </button>
      </div>
