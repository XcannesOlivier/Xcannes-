...
export default function WalletSettingsDropdown({
  ...
  return (
    <div className={visibilityClass} ref={ref}>
      ...
      >
        <svg
          className={inlineButton ? "w-[30px] h-[30px] lg:w-[20px] lg:h-[20px] opacity-70 hover:opacity-90" : "w-6 h-6 lg:w-5 lg:h-5"}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          strokeWidth={1.8}
        ...
        <span className="hidden lg:inline text-base font-light text-white/80">
