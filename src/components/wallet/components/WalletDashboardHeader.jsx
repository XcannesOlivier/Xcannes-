...
export default function WalletDashboardHeader({
  ...
  return (
    <div
      className="panel-header flex flex-col shrink-0 bg-[#111518] shadow-[inset_0_16px_28px_rgba(255,255,255,0.08),inset_0_-26px_46px_rgba(0,0,0,0.55)] px-3 pt-3 pb-4 md:px-5 md:pt-4 md:pb-5"
    >
