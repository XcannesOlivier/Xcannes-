          ...
          <div className="w-full mt-1 md:mt-1.5 mb-2 md:mb-3 px-1 md:px-2 flex justify-center">
	            <div className="relative flex items-center gap-2.5 w-full md:max-w-[520px]">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {isSwitcherOpen && hasMultipleWallets && (
                      <div
                        className={`absolute z-50 left-0 top-full mt-0 w-full rounded-b-xl bg-[#0b0f10] shadow-[0_12px_48px_rgba(0,0,0,0.45)] max-h-[340px] overflow-y-auto overflow-x-hidden origin-top transition-all duration-[550ms] ${
                          isSwitcherVisible
