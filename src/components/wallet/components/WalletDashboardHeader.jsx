  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2 pb-4 md:pb-0">
        ...
        {isConnected && wallet && (
          <div className="w-full mt-1 md:mt-0 mb-2 md:mb-0 px-1 md:px-2 flex justify-center md:justify-between">
	            <div className="relative flex items-center gap-2.5 w-full md:w-full">
	              ...
	              <div className="flex-1 md:flex-none md:min-w-[280px] min-w-0 rounded-md bg-[#0b0f10] px-2.5 md:px-3 py-2 shadow-none relative z-[41]">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {isSwitcherOpen && hasMultipleWallets && (
                      <div
                        className={`absolute z-50 left-0 top-full mt-0 w-full rounded-b-xl bg-[#0b0f10] shadow-[0_12px_48px_rgba(0,0,0,0.45)] max-h-[70vh] md:max-h-[340px] overflow-y-auto overflow-x-hidden origin-top transition-all duration-[550ms] ${
                          isSwitcherVisible
        ...
        <div className="text-lg md:text-base text-white/60 tracking-[0.18em] uppercase mb-2 md:mb-0">
