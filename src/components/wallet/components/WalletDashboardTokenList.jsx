...
export default function WalletDashboardTokenList({
  ...
  const listClassName = disableInternalScroll
    ? `flex-1 min-h-0 px-3 ${hasHeader ? "pt-[2px] md:pt-[4px]" : "pt-1.5"} pb-[72px] md:pb-[4px] rounded-2xl bg-transparent`
    : `flex-1 min-h-0 px-3 ${hasHeader ? "pt-[2px] md:pt-[4px]" : "pt-1.5"} pb-[72px] md:pb-[4px] overflow-y-auto overscroll-contain rounded-2xl bg-transparent`;
