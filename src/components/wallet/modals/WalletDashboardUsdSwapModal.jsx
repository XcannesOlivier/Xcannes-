...
import {
  ...
  PRIORITY_TICKERS,
  SWAP_DIRECTIONS,
  MAX_STABLE_SEARCH_RESULTS,
  QUICK_STABLE_TARGETS,
  POPULAR_STABLE_TARGETS,
  SIMPLESWAP_DEPOSITS_STORAGE_KEY,
  SIMPLESWAP_DEPOSITS_MAX,
  XRP_RAIL_CURRENCY,
  pick,
  currencyKey,
  currencyLabel,
  matchStableTarget,
  renderCurrencyIcon,
  renderWalletOptionIcon,
  safeReadJsonArray,
  parseSimpleSwapRanges,
  parseSimpleSwapEstimateAmount,
  buildXrpPaymentTxjson,
  parseDestinationTag,
  encodeTextToHex,
  buildPlainTextMemo,
  normalizeAddressNetworkFamily,
  validateAddressByNetworkFamily,
} from "./simpleSwapUtils";
import { ErrorBanner, WarnBanner, InfoBanner } from "./simpleSwapBanners";
              ...
              <div className="space-y-5 relative z-[2]">
                ...
                {step === "form" ? (
                  <>
                      ...
                      <div className="p-4 pb-8 md:p-6 md:pb-10">
                        {direction === SWAP_DIRECTIONS.STABLE_TO_RLUSD ? (
                          <div className="grid grid-cols-[minmax(0,1fr)_auto] md:grid-cols-2 gap-x-4 md:gap-x-7 gap-y-3 md:gap-y-4 items-end">
                            ...
                            <div className="text-[12px] md:text-[13px] text-white/55 text-center md:text-left">
                            ...
                            <div ref={stableDropdownRef} className="flex items-end">
                              <button
                                type="button"
                                onClick={() => {
                                  setSourceDropdownOpen(false);
                                ...
                                className="inline-flex items-center gap-2 md:gap-3 rounded-full bg-elevated ring-1 ring-white/10 px-3 py-1.5 md:px-4 md:py-2 text-white/85 hover:ring-white/20 transition-colors md:w-full"
                              >
                                {stableCurrency ? (
                          ...
                          <>
                            {direction === SWAP_DIRECTIONS.RLUSD_TO_STABLE && walletSourceSelectionEnabled ? (
                              <div className="grid grid-cols-[minmax(0,1fr)_auto] md:grid-cols-2 gap-x-4 md:gap-x-7 gap-y-3 md:gap-y-4 items-end">
                                ...
                                <div ref={sourceDropdownRef} className="flex items-end">
                                  <button
                                    type="button"
                                    onClick={() => {
                                      setStableDropdownOpen(false);
                            ...
                            {t(
                              ...
                              <div className="text-white text-4xl md:text-5xl font-semibold tracking-tight truncate">
                                {hasValidAmount ? (
	                              ...
	                              <div ref={sourceDropdownRef} className="flex items-end pb-1">
	                                <button
	                                  type="button"
	                                  onClick={() => {
	                                    setStableDropdownOpen(false);
                                ...
                                <div className="text-white text-4xl md:text-5xl font-semibold tracking-tight truncate">
                                  {hasValidAmount ? (
	                                ...
	                                <div ref={stableDropdownRef} className="flex items-end pb-1">
	                                  <button
	                                    type="button"
	                                    onClick={() => {
	                                      setSourceDropdownOpen(false);
                      ...
                      {showCurrenciesLoadingInCta ? (
                        ...
                        ? <span className="inline-flex items-center gap-1.5 text-white/85">
                            ...
                            <span className="inline-flex items-end gap-[3px] mb-[-1px]">
                              ...
                              <span className="usdswap-dot" style={{ animationDelay: '1.2s' }}>·</span>
                            </span>
                          </span>
                    ...
                    <style>{`
                      @keyframes usdswapDotBlink {
                        0%, 100% { opacity: 0.18; }
                        50% { opacity: 0.7; }
                      }
                      .usdswap-dot {
                        animation: usdswapDotBlink 2.4s ease-in-out infinite;
                        font-size: 1.3em;
                        line-height: 1;
                      }
                    `}</style>
