            ...
            <div className="flex justify-center">
                ...
                <span className="text-white/95 text-[14px] md:text-[15px] font-semibold">
		          ...
		          <div className={wizardStep === 1 ? "relative z-[65]" : "hidden"}>
		              ...
		              <ModalSelect
		                ...
		                menuHeader={t("moonpay_sell_send_currency_label", "Devise à envoyer")}
	          ...
	          {/* Amount input (étape 1/2) */}
	            <div className={wizardStep === 1 ? "" : "hidden"}>
	              ...
	              <div className={[
	                'relative flex items-center gap-3 px-5 pt-5 pb-5 rounded-[18px] bg-black/40 backdrop-blur-sm ring-1 ring-white/10 ring-inset transition-all duration-200',
