    ...
    <div ref={contentRootRef} className="relative min-h-full flex flex-col">
      ...
      {step === "form" && (
        <div className="space-y-5">
          ...
          {/* Title + Wallet pill */}
          {wizardStep === 1 ? (
		          <div className={`relative z-[66] px-4 md:px-0 ${hasValidAmount && !conversionMissing ? 'pt-[16px]' : 'pt-[40px]'} md:pt-[90px] pb-4 text-center md:text-left`}>
            ...
            {isBankSellFlow ? (
              <div className="mb-4 flex flex-col items-center md:items-start">
	                <p className="mt-2 text-[19px] md:text-[20px] font-light text-white/50 max-w-[34ch] md:max-w-[68ch] mx-auto md:mx-0 leading-snug md:leading-relaxed">
	                  {t(
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={["h-2.5 w-2.5 md:h-2 md:w-2 rounded-full ring-4 shrink-0 wallet-dot-active", accentRing25Bg].join(" ")}
                    aria-hidden
                  />
	              ...
	              <div className={[
	                ...
	                'focus-within:ring-white/25 focus-within:shadow-[0_4px_18px_rgba(0,0,0,0.6),inset_0_16px_28px_rgba(255,255,255,0.08),inset_0_-14px_24px_rgba(0,0,0,0.30),0_0_0_1px_rgba(255,255,255,0.10),0_0_24px_rgba(255,255,255,0.06)]',
                      ...
                      readOnly={wizardStep !== 1}
			                  className={[
	                        "flex-1 min-w-0 bg-transparent text-white text-4xl md:text-5xl font-light placeholder:text-white/35 focus:outline-none transition-all duration-150",
              ...
              {hasValidAmount && !conversionMissing ? (
                <div className="mt-4 flex flex-col gap-2 animate-fade-in">
                  ...
                  <button
                    ...
                    className={['text-[13px] font-light underline underline-offset-[3px] decoration-1 transition-opacity hover:opacity-75', accentText90].join(' ')}
                  >
          ...
          <button
            ...
            className={[
              "md:hidden mt-11 w-full h-[52px] md:h-[56px] flex items-center justify-center rounded-[14px] text-[22px] md:text-[24px] font-light transition-all duration-200 tracking-[-0.01em]",
              continueDisabled
                ? isSendToWalletFlow
          ...
          <button
            ...
            disabled={continueDisabled}
            className={[
              "hidden md:flex mt-11 items-center justify-center w-full h-[52px] md:h-[56px] rounded-[14px] text-[22px] md:text-[24px] font-light transition-all duration-200 tracking-[-0.01em]",
              continueDisabled
                ? isSendToWalletFlow
                  ? "text-white/90 cursor-not-allowed ring-[0.5px] ring-orange-500/30 ring-inset"
                  : "text-white/90 cursor-not-allowed ring-[0.5px] ring-violet-500/30 ring-inset"
		                    ...
		                    {t("ui_op_flow_control_card", "Aucune opération n’est effectuée sans votre validation.")}
					                ...
					                <div className="text-[14px] leading-snug text-white/80 space-y-8">
					                  <div className="relative isolate flex gap-x-4">
					                    <div className="relative z-10 flex w-10 justify-center">
					                      <span className={["inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-transparent", sheetAccentFlowIconText].join(" ")}>
					                        <CheckCircleIcon className="h-[40px] w-[40px]" style={{ strokeWidth: 1.25 }} aria-hidden="true" />
					                      </span>
					                    </div>
					                  ...
					                  <div className="relative isolate flex gap-x-4">
					                    <div className="relative z-10 flex w-10 justify-center">
					                      <span className={["inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-transparent", sheetAccentFlowIconText].join(" ")}>
					                        <ShieldCheckIcon className="h-[40px] w-[40px]" style={{ strokeWidth: 1.25 }} aria-hidden="true" />
					                      </span>
					                    </div>
					                    <div className="relative z-10 min-w-0">
					                      <div className="text-white/90 font-light">
					                  ...
					                  <div className="flex gap-x-4">
					                    <div className="flex w-10 justify-center">
					                      <span className={["inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-transparent", sheetAccentFlowIconText].join(" ")}>
					                        <BanknotesIcon className="h-[40px] w-[40px]" style={{ strokeWidth: 1.25 }} aria-hidden="true" />
					                      </span>
					                    </div>
					                    <div className="relative z-10 min-w-0">
					                      <div className="text-white/90 font-light">
