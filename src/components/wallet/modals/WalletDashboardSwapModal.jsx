                    ...
                    <div className="flex items-center justify-between mb-2 relative z-[41]">
                      ...
                      options={(swapCurrencyOptionsSanitized || []).map((code) => {
                        ...
                        return {
                          ...
                          openButtonClassName="!bg-white/10 !border !border-white/20 !border-b-0 ring-1 ring-white/20 shadow-[0_8px_18px_rgba(0,0,0,0.45)]"
		                      menuClassName={
		                        noticeVariant === "demo"
                              ? "bg-xcannes-surface-demo border-white/20 ring-1 ring-white/20 ring-inset max-h-[520px]"
                              : "bg-[#101415] border-white/20 ring-1 ring-white/20 ring-inset max-h-[520px]"
		                      }
                      ...
                      options={(swapCurrencyOptionsSanitized || []).map((code) => {
                        ...
                        return {
                          ...
                          optionClassName="py-2.5 md:py-3"
		                      menuClassName={
		                        noticeVariant === "demo"
                              ? "bg-xcannes-surface-demo border-white/20 ring-1 ring-white/20 ring-inset max-h-[220px]"
                              : "bg-[#101415] border-white/20 ring-1 ring-white/20 ring-inset max-h-[220px]"
		                      }
                          menuFooter={(
