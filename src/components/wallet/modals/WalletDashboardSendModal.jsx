...
export default function WalletDashboardSendModal({
  ...
  const panelClass = [
    "relative w-full wallet-modal-panel wallet-send-modal wallet-modal-no-top-highlight-mobile border-white/10 md:border p-4 md:p-5 pt-0 md:pt-0 space-y-4 flex flex-col pointer-events-auto pb-[env(safe-area-inset-bottom)] shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-26px_46px_rgba(0,0,0,0.55)]",
    inline
      ...
      <div className={wrapperClass}>
        ...
        >
          ...
          >
            ...
            {/* Back chevron – masqué sur mobile (remplacé par le swipe) */}
            <div className="hidden md:flex px-1 pt-0 pb-0 items-center relative z-[65]">
