                ...
                <div className="flex flex-col gap-3 md:gap-5">
                  ...
                  <div className="relative rounded-[20px] bg-elevated" ref={quickscanSavedPickerRef}>
                    <button
                      ...
                      className="w-full flex items-center gap-4 bg-transparent ring-1 ring-inset ring-white/10 rounded-[20px] px-4 py-4 hover:ring-white/15 transition-colors duration-150 text-left"
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className={`flex items-center justify-between ring-1 ring-inset rounded-xl pl-3 pr-2.5 py-2 transition-colors duration-150 ${selectedContactDisplay ? 'bg-black/80 ring-white/10' : 'bg-black/80 ring-white/10'}`}>
