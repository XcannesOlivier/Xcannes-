                ...
                <div className="flex flex-col gap-3 md:gap-5">
                  ...
                  <div className="relative rounded-[20px] bg-elevated" ref={quickscanSavedPickerRef}>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className={`flex items-center justify-between ring-1 ring-inset rounded-xl pl-3 pr-2.5 py-2 transition-colors duration-150 ${selectedContactDisplay ? 'bg-transparent ring-white/10' : 'bg-transparent ring-white/15'}`}>
