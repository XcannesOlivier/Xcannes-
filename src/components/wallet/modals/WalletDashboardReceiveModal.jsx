      ...
      <div className={wrapperClass}>
        ...
        >
          <div
            ...
            style={{ backgroundImage: 'radial-gradient(400px circle at 12% 0%, rgba(255,255,255,0.06) 0%, transparent 50%), radial-gradient(600px circle at 50% 25%, rgba(0,255,150,0.04) 0%, transparent 60%)' }}
            onPointerDown={event => {
