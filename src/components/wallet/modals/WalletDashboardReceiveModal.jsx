...
export default function WalletDashboardReceiveModal({
  ...
  const choiceCardGreenClassName = `${choiceCardBaseClassName} ring-xcannes-green/15 hover:ring-xcannes-green/25 shadow-[0_-12px_36px_rgba(0,200,120,0.12),0_14px_46px_rgba(0,0,0,0.58),inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-22px_34px_rgba(0,0,0,0.72)]`;
