	                          ...
	                          {hasMultipleWallets && (
	                            <div className="absolute inset-0 z-10">
                                  ...
                                  onOpenChange={setShareWalletDropdownOpen}
	                                ...
	                                menuClassName="bg-elevated !mt-0 !max-h-64 overflow-y-auto overscroll-contain touch-pan-y border border-white/20 border-t-0 rounded-b-[20px] shadow-[0_14px_38px_rgba(255,255,255,0.06),0_28px_70px_rgba(0,0,0,0.72)] !z-[10020]"
