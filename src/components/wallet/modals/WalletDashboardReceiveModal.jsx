...
export default function WalletDashboardReceiveModal({
  ...
  const panelClass = [
    'relative w-full wallet-modal-panel wallet-receive-modal border-white/10 md:border lg:border-0 p-4 md:p-5 space-y-0 flex flex-col min-h-0 overflow-y-auto overscroll-contain pointer-events-auto pb-[env(safe-area-inset-bottom)]',
    inline
                    ...
                    <div className="absolute inset-0 bg-[radial-gradient(700px_circle_at_0%_100%,rgba(0,255,150,0.04),transparent_65%)]" />
                      ...
                      <div className="flex justify-center pt-1 pb-1 relative z-[85]">
                          ...
                          <button
                            ...
                            className={`relative flex w-fit flex-col items-center gap-1 bg-transparent px-6 py-2 ${shareWalletDropdownOpen ? accountDropdownOpenPillClassName : 'rounded-3xl'} ring-1 ring-white/15 ring-inset ${hasMultipleWallets ? 'cursor-pointer' : ''}`}
	                    ...
	                    <div className="grid grid-cols-2 gap-3">
	                      <button
	                        ...
	                        className={[
	                          'w-full h-11 rounded-[20px] bg-[#101415] ring-1 ring-white/10 ring-inset text-white/85 text-xs font-semibold mt-6 md:mt-[50px]',
                          ...
                          className="w-full h-11 rounded-[20px] bg-[#101415] text-white text-[17px] font-bold tracking-wide py-2 px-6 transition-all duration-[140ms] inline-flex items-center justify-center gap-2.5 hover:bg-white/[0.04] scale-[1.04] active:scale-[0.98] mt-6 md:mt-[50px]"
