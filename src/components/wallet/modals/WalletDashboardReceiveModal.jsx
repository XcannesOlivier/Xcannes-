    ...
    <>
      ...
      {qrZoomValue ? (
        ...
        >
          ...
          <div
            className="w-[80vw] max-w-[360px] aspect-square rounded-[20px] bg-white p-4"
	                    ...
	                    <div className="w-full flex justify-center">
	                      <div className="relative group">
	                        <div
	                          ...
	                          className="w-[220px] md:w-[200px] aspect-square rounded-[14px] bg-[#e8e8e8] p-3 cursor-pointer"
	                        ...
	                        <button
	                          type="button"
	                          onClick={e => { e.stopPropagation(); setQrZoomValue(receiveQrValue); }}
	                          className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-black/60 ring-1 ring-white/20 flex items-center justify-center text-white/80 hover:bg-black/80 transition-all duration-150 opacity-80 hover:opacity-100"
	                          aria-label="Zoom QR"
	                        >
		                  ...
		                  <div className="space-y-5 pt-2">
				                    {hasGeneratedRequest ? (
				                        ...
				                        <div className="relative group">
				                          ...
				                          <button
				                            type="button"
				                            onClick={e => { e.stopPropagation(); setQrZoomValue(requestQrValue); }}
				                            className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-black/60 ring-1 ring-white/20 flex items-center justify-center text-white/80 hover:bg-black/80 transition-all duration-150 opacity-80 hover:opacity-100"
				                            aria-label="Zoom QR"
				                          >
				                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
