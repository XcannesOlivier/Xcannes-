          ...
          >
            ...
            {receiveView !== 'choice' ? (
              ...
              >
                ...
                <p className={`max-w-[34ch] md:max-w-[68ch] ${receiveView === 'share' ? 'mt-px md:mt-0 mb-[3.5px] md:mb-[4px] leading-[22.5px] md:leading-[24px] text-[19px] md:text-[20px] font-light text-white/50' : receiveView === 'request' || receiveView === 'request_qr' ? 'mt-px md:mt-0 mb-[3.5px] md:mb-[4px] leading-[22.5px] md:leading-[24px] text-[19px] md:text-[20px] font-light text-white/50' : 'mt-1 md:mt-2 leading-snug text-[18px] md:text-[19px] font-light text-white/60'}`}>
                  {headerSubtitle}
                </p>
              </div>
            ) : null}
            ...
            {receiveView === 'request_qr' ? (
              <div className="hidden md:flex pointer-events-none justify-center mt-auto pt-2 pb-0 relative z-[5]" aria-hidden>
                <span className="block w-[120px] h-[4px] rounded-full bg-white/60" />
              </div>
            ) : null}
