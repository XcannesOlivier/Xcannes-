...
export default function WalletDashboardReceiveModal({
  ...
  const panelClass = [
    "relative w-full wallet-modal-panel wallet-receive-modal border-white/10 md:border p-4 md:p-5 space-y-3 overflow-y-auto flex flex-col min-h-0 overscroll-contain pointer-events-auto",
    inline
