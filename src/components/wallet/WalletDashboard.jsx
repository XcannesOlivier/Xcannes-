      ...
      >
        <div className="flex flex-col min-h-0 relative inline-panel-left">
          ...
          <div className="relative flex-1 flex flex-col lg:flex-row min-h-0">
            ...
            <div className="lg:hidden absolute top-0 left-0 right-0 z-[8] pointer-events-none bg-[#0b0f10]" data-scrolled={tokenListScrolled}>
            ...
            <div className="hidden lg:flex flex-col min-h-0 border-l border-white/5 w-[230px] shrink-0">
              ...
              <div className="border-t border-white/5 flex flex-col gap-1 px-5 py-5">
                <WalletCurrencySelector
                  ...
                  buttonClassName="w-full flex items-center gap-2 text-base font-light text-white/45 hover:text-white/80 transition-colors px-3 py-2 rounded-lg"
                  placeholder={t('ui_search_all_currencies_c5d6e7f8', 'Search currency...')}
                  excludeCodes={['USD', 'RLUSD', 'XRP']}
                  showQuickAdd={false}
                  closeSignal={activeAction}
                ...
                <div className="w-full"><WalletCurrencySelector
                  ...
                  triggerLabel={
                    <span className="flex flex-col items-center justify-center gap-[3px]">
                      <span className="text-[20px] font-light leading-none text-white/75 group-hover:text-white/90 transition-colors">+</span>
                  ...
                  buttonClassName="w-full h-full flex flex-col items-center justify-center gap-[3px] transition-opacity hover:opacity-75 active:opacity-50 focus-visible:outline-none px-3 group"
