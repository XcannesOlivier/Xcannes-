      ...
      >
        <div className="flex flex-col min-h-0 relative inline-panel-left">
          ...
          <WalletDashboardFooter
            ...
            addCurrencySlot={
              !isDesktopPanel ? (
                <div className="w-full px-[2.5%]"><WalletCurrencySelector
                  value=""
                  onChange={handleAddDevise}
                  triggerVariant="text"
                  triggerLabel={
                  ...
                  buttonClassName="w-full h-[40px] flex flex-row items-center justify-center gap-1.5 transition-colors px-3 group rounded-[16px] bg-gradient-to-b from-[#101415] to-[#0d1214] ring-1 ring-white/[0.04] ring-inset shadow-[-3px_3px_10px_2px_rgba(255,255,255,0.03),0_2px_8px_rgba(0,0,0,0.35),inset_0_-10px_14px_rgba(0,0,0,0.7)]"
