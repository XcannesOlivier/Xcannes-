      ...
      {shouldRender ? (
        portalTarget
          ...
          <>
            {/* Backdrop */}
            <div
              className={`fixed inset-0 z-[50000] bg-black/80 md:backdrop-blur-sm ${
                isClosing
            ...
            <div className="fixed inset-0 z-[50001] flex items-stretch md:items-center justify-center px-0 pb-0 md:px-4 md:pb-0 pointer-events-none">
              <div
                role="dialog"
                aria-modal="true"
                aria-label={t("ui_settings_label", "Paramètres")}
                ...
                <div className="flex items-center justify-between px-4 pt-4 pb-3">
                  <div className="min-w-0">
                    ...
                    <div className="text-[12px] text-white/80 mt-1 truncate">
                      {t(
                        "ui_demo_wallet_settings_subtitle",
                        "Démo — mise en place",
                      )}
                    </div>
                  </div>
                ...
                <div className="shrink-0 border-t border-white/10 bg-black/20 px-3 py-3">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[11px] text-white/45 mt-0.5">
                        {t(
                          "ui_settings_open_info_hint",
                          "Infos du wallet et frais",
                        )}
                      </div>
                    </div>
                  </button>
