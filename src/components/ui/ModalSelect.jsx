    ...
    <>
      ...
      <div className={customMenuClassName}>
        ...
        {open && (
          <div
            ref={popupRef}
            className={`absolute z-50 mt-0 w-full max-h-64 overflow-y-auto rounded-b-lg border border-t-0 border-white/[0.06] shadow-2xl origin-top transition-all duration-[350ms] ${
              visible
