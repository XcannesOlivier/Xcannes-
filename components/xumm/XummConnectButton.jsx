          ...
          >
            <div className="w-full max-w-md rounded-2xl border border-white/10 bg-gray-900 p-5 text-white shadow-2xl">
              ...
              <ol className="mt-3 space-y-1 text-xs text-white/60">
                <li>1. Installez Xumm sur votre mobile.</li>
                <li>2. Ouvrez l&apos;app et creez votre wallet.</li>
                <li>3. Revenez ici et connectez-vous via QR code.</li>
              </ol>
              <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/15 border border-white/15 px-4 py-2 text-sm font-semibold"
                >
                  App Store
                </a>
                <a
