    ...
    <section className="relative py-24 px-4 sm:px-6 overflow-hidden">
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 text-left">
          ...
          <div className="relative overflow-hidden bg-xcannes-background text-white/90 shadow-2xl border-l-4 border-xcannes-green rounded-lg p-5 group transition-all duration-300">
            ...
            <div className="relative flex flex-col items-start gap-2">
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-2 rounded-lg bg-xcannes-green hover:bg-xcannes-green/90 text-white text-sm font-semibold transition-all duration-200"
              >
                {t("buy_step1_button1")}
              </a>
              <Link
                href="/activate-wallet"
                className="inline-flex items-center justify-center px-6 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white text-sm font-medium border border-white/15 transition-all duration-200"
              >
                {t("buy_step1_button2")}
              </Link>
            </div>
          ...
          {/* Étape 2 */}
          <div className="relative overflow-hidden bg-xcannes-background text-white/90 shadow-2xl border border-white/10 rounded-lg p-5 group transition-all duration-300">
            {/* Gros numéro en arrière-plan */}
            <div className="absolute -top-4 -right-4 text-[120px] font-orbitron font-bold text-xcannes-green/10 group-hover:text-xcannes-green/20 transition-colors duration-300 select-none">
              02
            </div>
            ...
            <a
              ...
              className="relative inline-flex items-center justify-center px-6 py-2 rounded-lg bg-xcannes-green hover:bg-xcannes-green/90 text-white text-sm font-semibold transition-all duration-200"
            >
              {t("buy_step2_button")}
            </a>
          </div>
