# Documentation — Frontend (`Xcannes-`)
...
## Docs “au plus près du code”

Certains sous-modules gardent leur `README.md` à côté du code lorsqu’ils ont une logique autonome (ex: sous-dossier avec son propre `package.json`).

- Chart XRPL (module) : `src/components/dex/XrplCandleChart/README.md`
